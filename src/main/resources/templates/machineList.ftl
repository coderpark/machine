...
<div class="bloc">
    ...
    <div class="bloc">
        <div class="title">设备搜索</div>
        <div class="content">
            <form id="searchForm" action="/machine/search" method="post">
                <div class="line" style="">
                    <label style="display: inline-block;">设备名称:</label>
                    <input type="text" id="searchName" name="name">
                    <label style="display: inline-block;">设备序列号:</label>
                    <input type="text" id="searchSerial" name="serial">
                    <label style="display: inline-block;">保修日期:</label>
                    <input type="text" class="datepicker" id="searchFixDate" name="fixDate">
                    <label style="display: inline-block;">购买日期:</label>
                    <input type="text" class="datepicker" id="searchBuyDate" name="buyDate">
                    <label style="display: inline-block;">设备类型</label>
                    <select id="searchTyp" name="typId">
                        <option value="0">不选择</option>
                        <#list machineTyps as typ>
                            <option value="${typ.id!}">${typ.name!}</option>
                        </#list>
                    </select>
                </div>
                <div class="submit">
                    <input class="button" id="search" type="submit" target="content" value="搜索" ">
                </div>
            </form>
        </div>
    </div>
