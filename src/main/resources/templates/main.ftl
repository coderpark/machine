    ...
    <ul>
        ...
        <li class="current"><a href="#"><img src="/static/img/icons/menu/layout.png" alt="" /> 设备管理</a>
            <ul>
                ...
                <li class="current"><a href="/machine/list" target="content">设备列表</a></li>
                <li><a href="/move/list" target="content">变更记录</a></li>
                <li><a href="/machine/export">设备导出</a></li>
                <li><a href="/machine/typ/list" target="content">设备类型</a></li>
            </ul>
        </li>
...
<!--
      CONTENT
                -->
<iframe name="content" style="margin-left: 5%;" width="95%" height="600px" class="panel white" src="/machine/list" scrolling="auto" frameborder="0" marginwidth="0">
